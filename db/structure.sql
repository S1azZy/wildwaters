...
--
-- Name: region_closures region_closures_ancestor_descendant_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.region_closures
    ADD CONSTRAINT region_closures_ancestor_descendant_unique UNIQUE (ancestor_id, descendant_id);
...
ALTER TABLE ONLY public.region_closures
    ADD CONSTRAINT region_closures_pkey PRIMARY KEY (id);
